...
| [#2883](https://github.com/HKUDS/LightRAG/pull/2883) `open` | feat: expose LLM token usage in /query response |
| [#2882](https://github.com/HKUDS/LightRAG/pull/2882) `open` | fix: include doc_id in duplicate response when track_id is absent |
| [#2881](https://github.com/HKUDS/LightRAG/pull/2881) `open` | fix: include retrieved context in LLM query cache key |
...
| PR | Description |
|---|---|
| [#10033](https://github.com/KittyCAD/modeling-app/pull/10033) `merged` | fix: add hole::holes to stdLibMap for feature tree icon |
