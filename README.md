...
| [#2877](https://github.com/HKUDS/LightRAG/pull/2877) `merged` | fix: remove redundant file_path_placeholder lookup in \_merge\_edges\_then\_upsert |
...
| PR | Description |
|---|---|
| [#53773](https://github.com/zed-industries/zed/pull/53773) `open` | fix(languages): respect tab_size in Ruff and CSS formatters |
